(function () {
  ...
  window.__BRAND__ = {
    ...
    landingHero: {
      ru: {
        kicker: "Гомологация диплома врача в Испании",
        title: "Поможем признать ваш диплом врача и начать работать в Испании",
        sub: "С 2006 года сопровождаем врачей из России, Украины, Казахстана, Беларуси и других стран СНГ — больше 700 признанных дипломов, ни одного отказа. Процесс полностью дистанционный."
      },
      en: {
        kicker: "Medical degree homologation in Spain",
        title: "We help you get your medical degree recognised and start working in Spain",
        sub: "Since 2006 we've supported doctors from Russia, Ukraine, Kazakhstan, Belarus and other CIS countries — over 700 degrees recognised, zero rejections. The whole process is fully remote."
      },
      kz: {
        kicker: "Испанияда дәрігерлік дипломды гомологациялау",
        title: "Дипломыңызды таныту және Испанияда жұмыс істеуді бастауға көмектесеміз",
        sub: "2006 жылдан бері Ресей, Украина, Қазақстан, Беларусь және басқа ТМД елдерінен дәрігерлерді сүйемелдейміз — 700-ден астам танылған диплом, бірде-бір бас тарту жоқ. Процесс толықтай қашықтан өтеді."
      }
    },
