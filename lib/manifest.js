(function () {
  ...
  window.__BRAND__ = {
    ...
    whatsappBar: {
      ...
      en: "Discuss my case on WhatsApp",
      kz: "Жағдайымды WhatsApp-та талқылау"
    },
    ...
    whatsappMessage: {
      ...
      en: "Hello! I'm a doctor interested in working in Spain. I'd like to know what possibilities I have to get my degree recognised.",
      kz: "Сәлеметсіз бе! Мен дәрігермін және Испанияда жұмыс істегім келеді. Дипломымды тану үшін қандай мүмкіндіктерім бар екенін білгім келеді."
    },
    ...
    landingMotivation: {
      ...
      en: "If you've ever pictured yourself working as a doctor in Spain, the first step is finding out what's possible for your degree.",
      kz: "Егер сіз бір рет болса да өзіңізді Испанияда дәрігер болып елестеткен болсаңыз, бірінші қадам — дипломыңыздың қандай мүмкіндіктері бар екенін білу."
    },
    ...
    landingFinal: {
      ...
      en: {
        title: "Ready to find out what's possible with your degree?",
        sub: "Message us on WhatsApp — you'll get a real, personal reply.",
        button: "Message on WhatsApp"
      },
      kz: {
        title: "Дипломыңызбен не мүмкін екенін білуге дайынсыз ба?",
        sub: "Бізге WhatsApp-та жазыңыз — жеке және нақты жауап аласыз.",
        button: "WhatsApp-та жазу"
      }
    }
  };
})();
